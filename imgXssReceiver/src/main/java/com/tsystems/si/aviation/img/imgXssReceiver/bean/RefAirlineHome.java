 ...
 * @see com.tsystems.si.aviation.img.imgXssReceiver.bean.RefAirline
...
public class RefAirlineHome {
	...
	public RefAirline merge(RefAirline detachedInstance) {
		...
		try {
			RefAirline result = (RefAirline) sessionFactory.getCurrentSession()
	...
	public RefAirline findById(java.lang.Integer id) {
		...
		try {
			RefAirline instance = (RefAirline) sessionFactory
					.getCurrentSession()
					.get("com.tsystems.si.aviation.img.imgXssReceiver.bean.RefAirline",
							id);
			if (instance == null) {
	...
	public List findByExample(RefAirline instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.tsystems.si.aviation.img.imgXssReceiver.bean.RefAirline")
