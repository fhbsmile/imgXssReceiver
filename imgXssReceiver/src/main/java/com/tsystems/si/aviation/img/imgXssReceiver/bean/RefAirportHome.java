 ...
 * @see com.tsystems.si.aviation.img.imgXssReceiver.bean.RefAirport
...
public class RefAirportHome {
	...
	public RefAirport merge(RefAirport detachedInstance) {
		...
		try {
			RefAirport result = (RefAirport) sessionFactory.getCurrentSession()
	...
	public RefAirport findById(java.lang.String id) {
		log.debug("getting RefAirport instance with id: " + id);
		try {
			RefAirport instance = (RefAirport) sessionFactory
					.getCurrentSession()
					.get("com.tsystems.si.aviation.img.imgXssReceiver.bean.RefAirport",
							id);
			if (instance == null) {
	...
	public List findByExample(RefAirport instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.tsystems.si.aviation.img.imgXssReceiver.bean.RefAirport")
