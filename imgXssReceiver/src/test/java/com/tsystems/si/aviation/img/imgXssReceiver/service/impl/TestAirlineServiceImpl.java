...
public class TestAirlineServiceImpl{
	private static final Logger     logger               = LoggerFactory.getLogger(TestAirlineServiceImpl.class);
	@Autowired
   ...
   @Test
	public void testSaveOrUpdate() {
		...
		String str =null;
		URL url = ConfigurationUtils.locate("airline_CZ.xml");
		...
		RefAirline airline =AirlineMessage.parseBssAirline(str);
